               ...
               <div class="modal-body">
                    <form method="post" id="form_upd_bal">
                         ...
                         <div class="mb-2">
                              ...
                              <input name="total_profit" id="inp_t_profit" type="tel" class="form-control" placeholder="Enter total profit" octavalidate="R,DIGITS" value="<?php (isset($user['total_profit'])) ? print($user['total_profit']) : ''; ?>" />
                         </div>
                         <div class="mb-2">
