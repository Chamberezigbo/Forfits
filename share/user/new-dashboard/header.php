...
<head>
     ...
     <title> Forfits Solutions</title>
     <meta name="title" Content="Creativewealth - Dashboard">
     ...
     <link rel="stylesheet" href="https://creativewealth.ltd/share/assets/templates/bit_gold/css/color.php?color=CCA354">
</head>
                                   ...
                                   <ul class="navbar-nav main-menu ms-auto">
                                        ...
                                        <li class="menu_has_children"><a href="#0">Account</a>
                                             <ul class="sub-menu">
                                                  ...
                                                  <li><a href="twofactor.php">2FA Security</a></li>
