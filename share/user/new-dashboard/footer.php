          ...
          <div class="container">
               <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                         ...
                         <a href="../login.php" class="logo"><img src="../../assets/images/logoIcon/logo.png" alt="images"></a>
          ...
          <div class="container">
               <div class="row">
                    <div class="col-md-6 text-md-left text-center">
                         <p class="copy-right-text">&copy; 2023 <a href="../login.php" class="text--base"><?=$companyName ?></a>. All Rights Reserved</p>
                    </div>
                    <!-- <div class="col-md-6">
...
<script>
     (function($) {
          ...
          $('.policy').on('click', function() {
               $.get('https://creativewealth.ltd/share/cookie/accept', function(response) {
