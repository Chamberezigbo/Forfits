...
<!-- Mirrored from Forfits.ltd/share/plan by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 May 2023 11:52:09 GMT -->
<!-- Added by HTTrack -->
...
<head>
     ...
     <title> Forfits Solutions - Investment Plan</title>
     <meta name="title" Content="Forfits - Investment Plan">
     ...
     <meta name="apple-mobile-web-app-title" content="Forfits - Investment Plan">

     <meta itemprop="name" content="Forfits - Investment Plan">
     ...
     <meta property="og:url" content="plan.php">
     ...
     <link rel="stylesheet" href="assets/templates/bit_gold/css/colora100.css?color=CCA354">
</head>

<body>
     <div class="preloader">
          <div class="preloader__imges">
               <img src="assets/images/frontend/preloader/63c91bd834d561674124248.png" class="preloader__img one" alt="No Image">
               <img src="assets/images/frontend/preloader/63c91bd838a841674124248.png" class="preloader__img two" alt="No Image">
          </div>
     </div>
               ...
               <div class="header__bottom">
                    <div class="container">
                         <nav class="navbar navbar-expand-xl p-0 align-items-center">
                              <!--<a class="site-logo site-title" href="https://Forfits.ltd/share"><img-->
                              <!--        src="https://Forfits.ltd/share/assets/images/logoIcon/logo_bit_gold.png"-->
                              <!--        alt="site-logo"></a>-->
                              ...
                              <ul class="account-menu responsive-account-menu ms-3">
                                   <li class="icon"><a href="user/login.php"><i class="las la-user"></i></a></li>
                              </ul>
